...
void Plotter::resetVariables(QPainter *painter)
{
...
void Plotter::drawBackground(QPainter *painter)
{
    painter->save();
...
void Plotter::drawGraph(QPainter *painter)
{
    painter->save();
...
/*!
  ...
  */
void Plotter::addData(qreal data)
{
